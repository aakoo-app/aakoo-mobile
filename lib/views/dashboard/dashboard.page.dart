...
import 'package:aakoo_app/views/users/users.page.dart';
                ...
                children: [
                  Card(
                      child: Container(
                          ...
                          child: charts.BarChart(_generateChartData(),
                              animate: true))),
                  Card(
                      child: Container(
                          width: 120,
                          height: 120,
                          padding: EdgeInsets.all(16),
                          child: charts.PieChart(_generateChartData(),
                              animate: true))),
                  Card(
                      child: Container(
                          width: 120,
                          height: 120,
                          padding: EdgeInsets.all(16),
                          child: charts.LineChart(_generateLineChartData(),
                              animate: true))),
                ],
              ),
              Row(
